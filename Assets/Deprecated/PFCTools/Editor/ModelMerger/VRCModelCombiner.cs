...
{
    [MenuItem("PFCTools/Deprecated/ModelCombiner")]
    public static void OpenWindow()
    {
        VRCModelCombiner window = GetWindow<VRCModelCombiner>();
    ...
    private void TransferMeshToTarget(SkinnedMeshRenderer skinnedMesh, Transform newRoot)
    {
    ...
    private void ShiftMissingBones(SkinnedMeshRenderer skinnedMesh, Transform targetArmature)
    {
