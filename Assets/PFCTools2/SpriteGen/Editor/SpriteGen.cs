...
namespace PFCTools2.SpriteGen
{
    public class SpriteGenMenu : EditorWindow
    {
        ...
        readonly string OUTPUT_FOLDER = "Assets/SpriteGen";

        readonly int[] sides = new int[] { 4, 8, 16, 32, 64 };

        bool validSelection { get { return Selection.activeObject is GameObject; } }


        Button btn_export;
        IntegerField input_Radial;
        IntegerField input_Angle;
        FloatField input_cameraSize;
        IntegerField input_Pixels;
        Label selectionLabel;

        [MenuItem("PFCTools2/Avatar Sprite Generator")]
